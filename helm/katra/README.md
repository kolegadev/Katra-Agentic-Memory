...
# helper: <release>-katra unless the release name already contains "katra")
kubectl port-forward svc/katra-katra 9002:9002 -n katra &
kubectl port-forward svc/katra-katra 3100:3100 -n katra &
```
