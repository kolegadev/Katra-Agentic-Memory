...
MY_AGENT_ID = os.environ.get("KATRA_USER_ID", "katra")
PEER_AGENT_ID = os.environ.get("KATRA_PEER_ID", "")
SHARED_ID = "my-team"
...
def write_bulletin_file(messages: list[str], path: str, agent_name: str):
    ...
    bulletin = {
        ...
        "messages": messages,
        "instruction": f"{agent_name} — check shared memory for full context. Use search_memories with query='inter-agent' and user_id='{MY_AGENT_ID}'.",
    }
