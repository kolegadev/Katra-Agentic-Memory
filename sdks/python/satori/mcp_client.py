...
.. attention::
   Most users should use :class:`satori.SatoriClient` which wraps this
...
Example
-------
>>> from satori import KatraMCPClient
...
class KatraMCPClient:
    ...
    def initialize(self) -> Dict[str, Any]:
        ...
        _LOGGER.info(
            ...
            self._server_info.get("serverInfo", {}).get("name", "satori"),
