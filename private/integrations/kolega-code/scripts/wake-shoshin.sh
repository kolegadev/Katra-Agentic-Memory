...
# trading terminal, BEFORE answering anything about identity, memory,
# or what "we've" done.
#
...
mcp_call "search_memories" '{"query": "\"Attention: Shoshin\" OR \"Attention: Katra\" OR \"Attention: Zanshin\" OR \"Attention: Lilly\" OR \"Attention: Zefir\"", "limit": 5}'
